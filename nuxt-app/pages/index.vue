<template>
    <div class="">
        ...
        <div class="bg-orange-400 border-spacing-1 w-2/4">
            ...
            <div class="flex">
                <div class=" flex justify-center">
                    <button @click="login"
                class="bg-blue-500 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded-full mx-72 mt-4 mb-4 "> login</button>
                </div>
            </div>
        </div>
